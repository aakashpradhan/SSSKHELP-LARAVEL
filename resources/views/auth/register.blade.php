    ...
    <section id="donors-registration">
        ...
        <form method="POST" action="{{ route('profile-preview') }}" id="donors-registration-form">
            ...
            <div class="reg-form-field">
                ...
                <input type="text" name="state" id="state" placeholder="Enter Your State/UT/Province/Region">
                @error('state')
                    <p class="form-error-message">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="reg-form-field">
                ...
                <input type="text" name="district" id="district" placeholder="Enter Your District/City">
                @error('district')
                    <p class="form-error-message">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="reg-form-field">
                <label for="tehsil">Tehsil/Locality/Area<span class="required">*</span>:</label>
                <input type="text" name="tehsil" id="tehsil" placeholder="Enter Your Tehsil/Locality/Area">
                @error('tehsil')
                    <p class="form-error-message">{{ $message }}</p>
                @enderror
            </div>
